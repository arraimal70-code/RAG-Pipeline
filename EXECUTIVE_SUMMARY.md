# RAG Pipeline Benchmark - Executive Summary
...
5. **Metrics Framework**: Comprehensive retrieval, generation, and performance metrics
...
3. **No LLM-as-Judge** - Simple keyword overlap used
